...
/** Sem refetch: a lista é pequena e a mutação já devolve o registro afetado. */
export function useLeadList(initialLeads: Lead[]) {
  ...
  // Ordenação não conta como filtro: a lista segue completa, então o estado
  // vazio deve continuar dizendo "cadastre o primeiro lead".
